...
_G.packer_plugins = {
  ...
  ["lsp-nowait.nvim"] = {
    ...
    loaded = true,
    path = "/home/thiagomm/.local/share/nvim/site/pack/packer/start/lsp-nowait.nvim"
  },
  ["lualine.nvim"] = {
...
-- Config for: lsp-nowait.nvim
time([[Config for lsp-nowait.nvim]], true)
require'lspNW'.check()
time([[Config for lsp-nowait.nvim]], false)
