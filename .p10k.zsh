# Generated by Powerlevel10k configuration wizard on 2020-10-09 at 23:50 -03.
...
() {
  ...
  # When set to true, icons appear before content on both sides of the prompt. When set to false, icons go after content. If empty or not set, icons go before content in the left
  ...
  function prompt_my_os_icon() {
    if ! [[ -v P9K_MY_OS_FOREGROUND ]]; then
      if [[ $P9K_OS_ICON == '' ]]; then
        ...
        typeset -g P9K_MY_OS_BACKGROUND=8
        typeset -g P9K_MY_OS_FOREGROUND=2
      else
        typeset -g P9K_MY_OS_BACKGROUND=8
