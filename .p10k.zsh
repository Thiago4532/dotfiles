# Generated by Powerlevel10k configuration wizard on 2020-01-20 at 16:48 -02.
# Based on romkatv/powerlevel10k/config/p10k-lean.zsh, checksum 11627.
# Wizard options: nerdfont-complete + powerline, large icons, lean, 2 lines,
# disconnected, left frame, lightest-ornaments, sparse, few icons, concise,
...
() {
  ...
  # Replfoace removed segment suffixes with this symbol.
  typeset -g POWERLEVEL9K_SHORTEN_DELIMITER=
  # Color of the shortened directory segments.
  typeset -g POWERLEVEL9K_DIR_SHORTENED_FOREGROUND=014
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local      clean='%B%003F'  # 003 foreground
      local   modified='%B%178F'  # yellow foreground
      local  untracked='%B%39F'   # blue foreground
      local conflicted='%B%196F'  # red foreground
    else
      # Styling for incomplete and stale Git status.
      local       meta='%B%244F'  # grey foreground
      local      clean='%B%244F'  # grey foreground
      local   modified='%B%244F'  # grey foreground
      local  untracked='%B%244F'  # grey foreground
      local conflicted='%B%244F'  # grey foreground
    fi
  ...
  # Custom prefix.
  typeset -g POWERLEVEL9K_VCS_PREFIX='%f%B%231Fon '
